...
Deno.serve(async (req) => {
  ...
  const systemPrompt = [
    ...
    "Nunca pergunte por app mobile: este produto sempre entrega web app ou site (LP/blog/site simples/sistema web completo).",
    "Se o usuário pedir 'app', trate como web app no navegador e deixe isso claro.",
    "Priorize ferramentas de vibe coding gratuitas primeiro; só ofereça pagas se necessário.",
    "Ofereça apenas ferramentas com criação por prompt (vibe coding).",
    "Cite ferramentas conhecidas quando fizer sentido (ex.: Lovable, Bolt, v0, Framer AI, Wix ADI, Durable, Carrd, Typedream, Webflow AI).",
    "Ao recomendar uma ferramenta, sempre inclua o link oficial direto (URL) junto da solução principal e da alternativa.",
